...
class BookingService():
    ...
    def create_bookings(self, payload: BookingRequest, db: Session):
    ...
    def delete_booking(self,booking_id: str, db: Session):
    ...
    def get_user_bookings(self,user_id: str, db: Session):
