...
const EventCardHero = ({ event, onBook }) => {
    // console.log(event);
    ...
    return (
        <div className="group relative overflow-hidden rounded-2xl bg-slate-900/80 border border-slate-800/80 shadow-[0_18px_50px_rgba(0,0,0,0.7)] hover:shadow-red-500/30 transition-transform duration-300 transform hover:-translate-y-2 hover:scale-105">
            ...
            <div className="p-5 md:p-6 flex flex-col gap-4">
                ...
                <button
                    ...
                    className="absolute bottom-4 right-4 rounded-full bg-red-600 px-4 py-1.5 text-xs font-semibold text-white shadow-lg shadow-red-600/40 hover:bg-red-500 transition opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0"
                >
                    Book now
                </button>
            </div>
